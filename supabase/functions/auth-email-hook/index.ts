...
// Configuration
const SITE_NAME = "shadowtalk-ai"
const SENDER_DOMAIN = "notify.www.shadowtalk-ai.com"
const ROOT_DOMAIN = "www.shadowtalk-ai.com"
const FROM_DOMAIN = "www.shadowtalk-ai.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://shadowtalk-ai.lovable.app"
...
Deno.serve(async (req) => {
  ...
  const currentCorsHeaders = getCorsHeaders(origin);
