...
import { 
  ...
  Rocket, Code, Palette, Megaphone, ArrowRight, Sparkles
} from "lucide-react";
                ...
                <Card className="card-glass group overflow-hidden">
                  ...
                  <CardContent className="p-6 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      ...
                      <Button variant="outline" className="shrink-0 hover:bg-primary/10 hover:text-primary hover:border-primary/30 transition-all">
                        Apply Now
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </div>
